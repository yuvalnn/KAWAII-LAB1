...
public class Drag : MonoBehaviour
{
    ...
    public GameObject PropsModel;


    private double ObjYPos = 1.441328;
    private Vector3 objPosition;
    public static float startLiveTime;
